(function(){
    ...
    for (const img of galerie_img) {
        img.addEventListener('mousedown',function(){
          boite_modale.classList.add('boite_modale-ouvrir')
